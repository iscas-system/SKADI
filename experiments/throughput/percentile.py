...
data_path = "/home/onceas/wanna/mt-dnn/results/2080Ti/2in7-load80"
...
def data_preprocess(target, platform, model_config, model_size="normal"):
    ...
    print(qos_target)
    print(data_dir)
    result_filepath = os.path.join(data_dir, "result-throughout.csv")
    ...
    for i in range(len(colo_names)):
        ...
        mtdnn3_load = mtdnn_latency.shape[0]
        ...
        mtdnn3_vio_ratio = 1 - mtdnn_vio / 1000
        ...
        #         abacus_vio / fcfs_vio - 1,
        #         abacus_vio / sjf_vio - 1,
        #         abacus_vio / edf_vio - 1,
        #     )
        # )
        print()
        csv_writer.writerow(
