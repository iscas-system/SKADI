...
class Query:
    ...
    # 每次同时更新start_pos和end_pos
    # start_pos更新为上一轮的end_pos
    # end_pos更新为new_pos(new_pos=-1表示运行完)
    ...
    def __str__(self) -> str:
        return "model_id: {}, bs: {}, seq_len: {}, start: {}, end: {}, op_len: {}, qos_target: {}, state: {}, load_id: {}".format(
            self.model_id,
            self.batch_size,
            self.seq_len,
            self.start_pos,
