        ...
        if self._total_models == 2:
            if self._mig == 0:
                self._data_path = os.path.join(
                    self._path, "data/profile/2080Ti/2in7")
                self._save_path = os.path.join(self._path, "model/2080Ti/2in7")
                self._result_path = os.path.join(
                    self._path, "result/2080Ti/2in7")
            elif self._mig == 2:
                self._data_path = os.path.join(
                    self._path, "data/profile/mig/2in4")
            ...
            self._data_path = os.path.join(
                self._path, "data/profile/2080Ti/3in4")
            self._save_path = os.path.join(self._path, "model/2080Ti/3in4")
            self._result_path = os.path.join(self._path, "result/2080Ti/3in4")
        elif self._total_models == 4:
            if self._mig == 0:
                if self._run_config.platform == "single":
                    self._data_path = os.path.join(
                        self._path, "data/profile/2080Ti/4in4")
                    self._save_path = os.path.join(
                        self._path, "model/2080Ti/4in4")
                    self._result_path = os.path.join(
                        self._path, "result/2080Ti/4in4")
                elif self._run_config.platform == "cluster":
                    self._data_path = os.path.join(
                        self._path, "data/profile/cluster/4in4"
                    )
                    self._save_path = os.path.join(
                        self._path, "model/cluster/4in4")
                    self._result_path = os.path.join(
                        self._path, "result/cluster/4in4")
                else:
                    raise NotImplementedError
            elif self._mig == 1:
                self._data_path = os.path.join(
                    self._path, "data/profile/mig/4in4")
